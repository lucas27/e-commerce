...
public class ExceptionsHadler {
    ...
    public ResponseEntity<ExceptionMessageDto> Exception(DataIntegrityViolationException e) {
        ExceptionMessageDto dto = new ExceptionMessageDto();
    ...
    public ResponseEntity<ExceptionMessageDto> Exception(QuantityExceededException e) {
        ExceptionMessageDto dto = new ExceptionMessageDto();
